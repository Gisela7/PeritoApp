...
public class TelaAuditoria extends javax.swing.JFrame {
    ...
    public TelaAuditoria() {
        ...
        this.setSize(1000, 600); // Mantendo o padrão da tela de relatório
    ...
    try {
        ...
        // Se o usuário digitou algo e não escolheu "Todos", aplica o filtro correspondente
        ...
        // Passa o parâmetro com "LOWER" e "%" para buscar partes do texto sem diferenciar maiúsculas/minúsculas
        if (!termo.isEmpty() && !tipoFiltro.equals("Todos")) {
    ...
    private void cbFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbFiltroActionPerformed
        if (cbFiltro.getSelectedItem().toString().equals("Todos")) {
            ...
            txtPesquisa.requestFocus(); // Põe o cursor do teclado no campo de texto
        }
